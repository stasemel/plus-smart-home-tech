...
@Slf4j
@Getter
public class KafkaHubEventConsumer implements AutoCloseable {
    private final KafkaConsumer<String, HubEventAvro> consumer;
    private final KafkaConfig kafkaConfig;

    public KafkaHubEventConsumer(KafkaConfig kafkaConfig) {
    ...
    private Properties getConfigProperties() {
        ...
        KafkaConfig.HubConsumer consumerConfig = kafkaConfig.getHubConsumer();
        ...
        KafkaConfig.HubConsumer.Properties properties = consumerConfig.getProperties();
