...
@Slf4j
@Getter
public class KafkaSnapshotConsumer implements AutoCloseable {
    private final KafkaConsumer<String, SensorsSnapshotAvro> consumer;
    private final KafkaConfig kafkaConfig;

    public KafkaSnapshotConsumer(KafkaConfig kafkaConfig) {
    ...
    private Properties getConfigProperties() {
        ...
        KafkaConfig.SnapshotConsumer consumerConfig = kafkaConfig.getSnapshotConsumer();
        ...
        KafkaConfig.SnapshotConsumer.Properties properties = consumerConfig.getProperties();
